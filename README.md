...
| Nest Labs | No Known Official Response | Nest Tweeted: "We plan to roll out patches to our products in the coming weeks. These won't require any action on the part of the user.", First firmware updates are [in distribution](https://nest.com/support/article/KRACK-vulnerability). Nest Protect still missing. | 2017-10-28 | 2017-10-28 |  |
...
| pfSense | [RELEASES](https://www.netgate.com/blog/pfsense-2-4-1-release-now-available.html) [LINK](https://redmine.pfsense.org/issues/7951) | pfSense 2.4.1 release contains "Fixes for the set of WPA2 Key Reinstallation Attack issues commonly known as KRACK" | 2017-10-17 | 2017-10-16 |  |
